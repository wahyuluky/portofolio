      ...
      <div className="hero grid md:grid-cols-2 items-center pt-5 xl:gap-0 gap-6 grid-cols-1">
        <div className="animate__animated animate__fadeInUp animate__delay-1s">
          ...
          <div className="flex items-center sm:gap-4 gap-2">
            <a href="https://drive.google.com/file/d/1osC6ZUDJOL06_Hw1j-lHbAKNqeGPOl0i/view?usp=sharing" className="bg-emerald-700 p-4 rounded-2xl hover:bg-emerald-600"><i className="ri-download-2-line ri-lg"></i> Download CV</a>
